...
meni.addEventListener("click",() =>{
   ...
   navbar.classList.toggle("promeni") ; 
  
  //ovaj toggle znaci na klik dodaje onom hamburgeru klasu promeni koja ga menja u x i ako ga kliknes ponovo ona ga vraca na hamburger i tako u krug 
//toggle mu dodaje klasu promeni ako je nema a ako je ima onda mu je sklanja i tako u krug 
